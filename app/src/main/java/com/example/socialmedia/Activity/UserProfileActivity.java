...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        followersCount = findViewById(R.id.followersCount1);
        followingCount = findViewById(R.id.followingCount1);
        followButton = findViewById(R.id.followButton1);
        postsRecyclerView = findViewById(R.id.postsRecyclerView1);
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Glide.with(UserProfileActivity.this).load(userProfile).placeholder(R.drawable.avtar).into(profileImage);
